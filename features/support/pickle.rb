...
#
    ...
    require File.join(File.expand_path(File.dirname(__FILE__)), '..', 'blueprints', 'blueprints.rb') # or wherever your factories are
...
#    require File.join(File.expand_path(File.dirname(__FILE__)), '..', 'factories', 'factories.rb') # or wherever your factories are
#
